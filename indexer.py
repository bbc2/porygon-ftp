...
class Index(ftplib.FTP):
    ...
    def search(self, dir, txt):
        db = whoosh.index.open_dir(dir)
        with db.searcher() as searcher:
            parser = whoosh.qparser.QueryParser('filename', db.schema)
